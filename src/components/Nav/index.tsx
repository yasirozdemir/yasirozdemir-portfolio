...
const Nav = () => {
  ...
  return (
    <nav
      className="fixed top-0 left-[50%] translate-x-[-50%] w-[95vw] sm:w-fit flex sm:justify-center sm:items-center z-20 h-[60px] rounded-b-lg shadow-[0_5px_50px_rgb(0,0,0,0.35)] bg-onyx text-honeydew"
      ref={navRef}
    >
